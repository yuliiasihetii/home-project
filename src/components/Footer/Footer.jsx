    ...
    return (
        <footer className='footer'>
            <Container>
                <Row>
                    <Col lg='3' md='4' sm='6'>
                        <div className="footer-logo text-start">
                            ...
                            <h5 className='logo-title-footer'>Tasty Treat</h5>
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatum facilis distinctio.</p>
                        </div>
                    </Col>

                    <Col lg='3' md='4' sm='6'>
                        <h5 className='delivery-title'>Delivery Time</h5>
                        <ListGroup className='delivery-time'>
                    ...
                    <Col lg='3' md='4' sm='6'>
                        <h5 className='delivery-title'>Contact</h5>
                        <ListGroup className='delivery-time'>
                            <ListGroupItem className='delivery-time-item border-0 ps-0'>
                    ...
                    <Col lg='3' md='4' sm='6'>
                        <h5 className='delivery-title'>Newsletter</h5>
                ...
                <Row className='mt-5'>
                    <Col lg='6' md='6'>
                        <p className='copyright-text'>Copyright - 2022, website made by Sihetii Yuliia.</p>
                    </Col>
